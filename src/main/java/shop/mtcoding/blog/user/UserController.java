...
public class UserController {
    ...
    @PostMapping("/join")
    public String join(@Valid UserRequest.JoinDTO joinDTO)//@Valid 어노테이션을 붙이면
    {
...
//        if (!r3) throw new Exception400("이메일 형식에 맞게 적어주세요");
    ...
    @PostMapping("/login")
    public String login(@Valid UserRequest.LoginDTO loginDTO, HttpServletResponse response) {
